...
export default function Aktuelles() {
  return (
    <main className="newsPage">
      ...
      <section className="newsHero"><p className="eyebrow">Aktuelles</p><h1>Was neu ist – und was daraus für die Kampagne folgt.</h1><p className="lead">Neue Urteile, Gesetze und Initiativen prägen die Entwicklung der Rechte der Natur. Hier zeigen wir Entwicklungen, die für die Kampagne besonders relevant sind.</p></section>
