...
export default function Artikel(){
  return <main className="newsPage">
    ...
    <article style={{maxWidth:860,margin:"0 auto",padding:"0 28px 72px",fontSize:"1.08rem",lineHeight:1.75}}>
      <p>Die Forderung, der Spree eigene Rechte zu geben, klingt zunächst nach einem grundlegenden Bruch mit dem bestehenden Umweltrecht. Doch wer genauer hinsieht, entdeckt etwas Interessantes: Viele Funktionen, die ein solcher neuer Rechtsstatus erfüllen soll, existieren bereits in anderer Form.</p>
      ...
      <p>Genau hier liegt der interessante Punkt des von Green Legal Impact veröffentlichten Gesetzentwurfs zu Rechten der Spree. Dr. Franziska Johanna Albrecht, die die Erarbeitung des Entwurfs koordinierte, beschreibt den juristischen Zugewinn in einer persönlichen Stellungnahme vor allem darin, dass die Spree nicht lediglich als schützenswertes Objekt berücksichtigt würde, sondern als juristisch handlungsfähiges Subjekt mit eigenen Belangen in Verwaltungs- und gegebenenfalls Gerichtsverfahren auftreten könnte. Das bedeutete nicht, dass ihre Interessen automatisch Vorrang hätten. Sie würden weiterhin mit anderen Interessen abgewogen.</p>
