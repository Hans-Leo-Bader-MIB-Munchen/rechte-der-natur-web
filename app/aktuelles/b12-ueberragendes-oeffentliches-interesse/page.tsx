...
export default function B12Artikel() {
  return <main className="newsPage">
    ...
    <section className="newsHero">
      ...
      <h1>{title}</h1>
      <p className="lead">Der Ausbau der B12 zeigt, warum gesetzliche Priorisierung, Umweltverbandsklage, Art. 20a GG und Rechte der Mitwelt nicht dasselbe leisten – und warum die konkrete Rechtsfunktion wichtiger ist als das Etikett eines Instruments.</p>
    </section>
    ...
    <article style={{maxWidth:860,margin:"0 auto",padding:"0 28px 72px",fontSize:"1.08rem",lineHeight:1.75}}>
      ...
      <p>Das wirft zwei Fragen auf: Hat die neue Rechtslage tatsächlich unmittelbaren Einfluss auf das laufende B12-Verfahren – und gibt sie der Verkehrsinfrastruktur gegenüber dem Klimaschutz nun Vorrang?</p>

      <h2>Ein konkreter Konflikt als Prüfbeispiel</h2>
      <p>Der Ausbau der B12 zwischen Untergermaringen und Buchloe eignet sich gerade deshalb als Prüfbeispiel. An diesem rund 10,2 Kilometer langen Planungsabschnitt lässt sich beobachten, wie unterschiedliche Ebenen des Umwelt- und Planungsrechts ineinandergreifen – und warum Begriffe wie „überragendes öffentliches Interesse“, Umweltverbandsklage oder Rechte der Mitwelt nicht dasselbe leisten.</p>
      ...
      <h2>Kontrolle ist nicht Repräsentation</h2>
      <p>Umweltverbandsklagen können erhebliche Kontroll- und Rechtsschutzfunktionen erfüllen. Der B12-Fall zeigt, dass bestehende Rechtsinstrumente Verfahren tatsächlich zur Nachprüfung und Ergänzung veranlassen können. Daraus folgt aber weder, dass ein Umweltverband rechtlich „die Natur“ oder ein konkretes Ökosystem repräsentiert, noch umgekehrt, dass deshalb eine neue Repräsentationsinstitution notwendig wäre. Kontrolle, Repräsentation und Rechtsträgerschaft sind verschiedene Funktionen.</p>
      <p>Genau hier beginnt die Fragestellung der Systemischen Rechtsentwicklung. Sie setzt nicht bei einer gewünschten Lösung an, sondern bei der Funktion: Was kann das bestehende System bereits? Wo liegt tatsächlich eine verbleibende Lücke? Könnte diese durch eine weniger weitgehende Veränderung bestehender Strukturen geschlossen werden? Erst wenn danach ein belastbarer Funktionsrest verbleibt, stellt sich die Frage nach einer zusätzlichen Rechtsposition oder Institution.</p>

      <h2>Was das bayerische Volksbegehren zusätzlich verändern will</h2>
      ...
      <h2>Art. 20a GG bleibt eine eigene Ebene</h2>
      ...
      <h2>Was sich aus dem Fall lernen lässt</h2>
      <p>Was lässt sich aus der B12 also lernen? Nicht, dass der Ausbau rechtmäßig oder rechtswidrig ist; darüber ist der anhängige Rechtsstreit nicht entschieden. Auch nicht, dass Rechte der Mitwelt den Ausbau verhindert hätten oder verhindern müssten. Der Erkenntniswert liegt an einer anderen Stelle: Der Fall zeigt, wie wichtig es ist, Rechtsfunktionen auseinanderzuhalten, bevor aus einem Konflikt eine Reformforderung abgeleitet wird.</p>
