...
export default function B12Artikel() {
  return <main className="newsPage">
    ...
    <article style={{maxWidth:860,margin:"0 auto",padding:"0 28px 72px",fontSize:"1.08rem",lineHeight:1.75}}>
      ...
      <p>Der Ausbau zwischen Untergermaringen und Buchloe eignet sich dafür besonders. Die Regierung von Schwaben stellte den vierstreifigen Ausbau dieses rund 10,2 Kilometer langen Abschnitts 2022 fest. Der BUND Naturschutz klagte dagegen und beanstandete unter anderem die Behandlung von Klima und Fläche. Daraufhin wurden die Umweltverträglichkeitsunterlagen ergänzt, die Öffentlichkeit erneut beteiligt und 2025 ein Ergänzungsbeschluss erlassen. Die Regierung hält den Ausbau nach erneuter Abwägung weiterhin für gerechtfertigt.</p>
      <p>Der BUND Naturschutz bewertet dies anders und hält unter anderem die Ermittlung der Auswirkungen auf Klima und Fläche sowie die Prüfung von Alternativen weiterhin für unzureichend. Ob diese Einwände rechtlich durchgreifen, ist nicht entschieden. Sie sind Klagepositionen des Verbands und keine bereits gerichtlich festgestellten Fehler.</p>
      <p>Für unsere Frage ist zunächst etwas anderes wichtig: Das bestehende Rechtssystem hat auf die Einwände reagiert. Unterlagen wurden ergänzt, Auswirkungen erneut geprüft und die Öffentlichkeit nochmals beteiligt. Umweltrecht und gerichtliche Kontrolle sind also keineswegs wirkungslos.</p>
      ...
      <p>Auch die Umweltverbandsklage hat eine klar erkennbare Funktion. Ein anerkannter Umweltverband kann gerichtlich überprüfen lassen, ob bestimmte umweltrechtliche Vorgaben eingehalten wurden. Der B12-Fall zeigt, dass solche Einwände ein Verfahren tatsächlich zur Nachprüfung und Ergänzung veranlassen können.</p>
      ...
      <p>Der entscheidende Unterschied lässt sich einfacher ausdrücken: <strong>Die Mitwelt wäre nicht mehr nur Gegenstand rechtlichen Schutzes, sondern selbst Trägerin einer Rechtsposition.</strong> Eine Beeinträchtigung müsste dann – nach hinreichender rechtlicher Konkretisierung – nicht nur daran gemessen werden, ob Menschen und Behörden die geltenden Umweltvorschriften eingehalten haben. Zusätzlich könnte die Frage entstehen, ob eine eigene Rechtsposition der betroffenen Mitwelt verletzt wurde.</p>
      <p>Das ist ein struktureller Unterschied. Es bedeutet aber noch nicht automatisch, dass im B12-Fall anders entschieden würde. Dafür müsste geklärt sein, welchen konkreten Inhalt diese Rechte haben, wann sie verletzt sind, wer sie vertreten kann, wie sie gerichtlich geltend gemacht werden und wie sie sich zu entgegenstehenden gesetzlichen Interessen verhalten. Gerade gegenüber einer gesetzlichen Priorisierung von Infrastruktur ist deshalb mit der Anerkennung eigener Rechte noch nicht entschieden, welches Interesse sich im Einzelfall durchsetzt.</p>
