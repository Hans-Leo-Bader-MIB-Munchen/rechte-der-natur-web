  ...
  return (
    <main className="aboutPage">
      ...
      <section className="aboutLayers">
        ...
        <article><span>02</span><div className="aboutLayerLogo"><img src="/brand/Netzwerk_Rechte_der_Natur_qgr-1ce3fa0e.png" alt="Logo Netzwerk Rechte der Natur" /></div><h3>Netzwerk</h3><p>Die Arbeit lebt von Menschen und Organisationen, die Erfahrungen, Kontakte, Öffentlichkeit und praktische Kampagnenkraft einbringen.</p><a className="aboutLayerLink" href="https://www.rechte-der-natur.de" target="_blank" rel="noreferrer">Zum Netzwerk Rechte der Natur ↗</a></article>
        <article><span>03</span><div className="aboutLayerLogo"><img src="/brand/SR_Logo_rund.png" alt="Logo Systemische Rechtsentwicklung" /></div><h3>Fachliche Vertiefung</h3><p>Die Systemische Rechtsentwicklung untersucht Rechtsformen und Wirkungsbedingungen eigenständig. Ihre Aufgabe ist belastbare Erkenntnis und die Weiterentwicklung rechtlicher Lösungen.</p><a className="aboutLayerLink" href="https://systemische-rechtsentwicklung.de" target="_blank" rel="noreferrer">Zur Systemischen Rechtsentwicklung ↗</a></article>
      </section>
