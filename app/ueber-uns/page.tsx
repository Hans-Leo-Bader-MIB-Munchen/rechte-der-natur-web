...
export default function UeberUns() {
  return (
    <main className="aboutPage">
      ...
      <section className="aboutHero"><p className="eyebrow">Über uns</p><h1>Wir sind Kampagne. Und wir entwickeln sie weiter.</h1><p className="lead">Die Arbeit begann mit dem Volksbegehren „Rechte der Natur“ in Bayern – und diese Kampagne läuft weiter. Gleichzeitig verbinden wir Kampagnenerfahrung mit internationaler Recherche und einer genaueren Frage: Wie können Rechte der Natur so ausgestaltet werden, dass sie politisch tragfähig und rechtlich wirksam werden?</p></section>

      <section className="aboutOrigin"><div><p className="sectionLabel">Herkunft und Gegenwart</p><h2>Bayern ist der Anfang – und weiterhin aktiv.</h2></div><div><p>Das Volksbegehren will Rechte der Natur in der Bayerischen Verfassung verankern. Dafür werden weiterhin Unterstützungsunterschriften für den Zulassungsantrag gesammelt.</p><p>Parallel ist eine größere Plattform entstanden: für neue Landesinitiativen, internationale Beispiele, aktuelle Entwicklungen und Menschen, die mitmachen wollen.</p><Link href="/volksbegehren/bayern">Zur laufenden Bayern-Kampagne →</Link></div></section>
