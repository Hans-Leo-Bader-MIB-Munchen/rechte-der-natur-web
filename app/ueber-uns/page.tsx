...
export default function UeberUns() {
  return (
    <main className="aboutPage">
      ...
      <section className="heritageStrip"><span>Gib der Natur Recht.</span><span className="heritageColors"><i/><i/><i/><i/></span><span>Aus einer Kampagne wurde eine Plattform.</span></section>

      <section className="aboutHero"><p className="eyebrow">Über uns</p><h1>Wir kommen aus einer Kampagne. Und wir wollen weiter Kampagne machen.</h1><p className="lead">Die Arbeit begann mit dem Volksbegehren „Rechte der Natur“ in Bayern. Heute verbinden wir Kampagnenerfahrung mit internationaler Recherche und einer genaueren Frage: Wie können Rechte der Natur so ausgestaltet werden, dass sie politisch tragfähig und rechtlich wirksam werden?</p></section>

      <section className="aboutOrigin"><div><p className="sectionLabel">Herkunft</p><h2>Bayern war der Anfang, nicht das Ende.</h2></div><div><p>Das Volksbegehren wollte Rechte der Natur in der Bayerischen Verfassung verankern. Dafür mussten nicht nur Texte entwickelt, sondern Menschen angesprochen, Unterstützer gewonnen und Unterschriften gesammelt werden.</p><p>Aus dieser Erfahrung ist eine größere Plattform entstanden: für neue Landesinitiativen, internationale Beispiele, aktuelle Entwicklungen und Menschen, die mitmachen wollen.</p><Link href="/volksbegehren/bayern">Zur Bayern-Geschichte →</Link></div></section>

      <section className="aboutLayers"><article><span>01</span><h3>Kampagne</h3><p>Die Rechte-der-Natur-Plattform erklärt, mobilisiert, verbindet und kann konkrete Volksbegehren und politische Initiativen unterstützen.</p></article><article><span>02</span><h3>Netzwerk</h3><p>Die Arbeit lebt von Menschen und Organisationen, die Erfahrungen, Kontakte, Öffentlichkeit und praktische Kampagnenkraft einbringen.</p></article><article><span>03</span><h3>Fachliche Vertiefung</h3><p>Die Systemische Rechtsentwicklung prüft Rechtsformen und Wirkungsbedingungen eigenständig. Ihre Aufgabe ist Erkenntnis – nicht Kampagnenbestätigung.</p></article></section>
