  ...
  return (
    <main id="top">
      ...
      <section className="bavariaFeature">
        ...
        <div className="bavariaCopy"><p className="sectionLabel">Bayern · Antragsphase · aktive Sammlung</p><h2>25.000 reichen formal. Wir wollen mindestens 250.000.</h2><p>Die Bayern-Kampagne sammelt bewusst weit über das gesetzliche Minimum hinaus. Das selbst gesetzte Ziel soll Öffentlichkeit schaffen, einen breiten Diskurs auslösen und die gesellschaftliche Basis für die späteren Stufen des Volksbegehrens legen.</p><div className="bavariaLinks"><Link href="/volksbegehren/bayern">Zur laufenden Bayern-Kampagne →</Link><a href="https://gibdernaturrecht.muc-mib.de/unterschriften-sammeln" target="_blank" rel="noreferrer">Unterschriften sammeln →</a></div></div>
      </section>
